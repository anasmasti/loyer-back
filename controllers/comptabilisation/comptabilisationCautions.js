      ...
      .then((data) => {
        // if (data.length > 0) {
          ...
          for (let i = 0; i < data.comptabilisation_loyer_debiter.length; i++) {
            let lieuIntitule =
              data.comptabilisation_loyer_debiter[i].intitule_lieu;

            let montantCaution =
              data.comptabilisation_loyer_debiter[i].montant_caution;
