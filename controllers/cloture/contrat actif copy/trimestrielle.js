...
module.exports = {
  traitementTrimestrielle: async (req, res, next) => {
    try {
      if (
              ...
              if (contrat[i].foncier.proprietaire[j].is_mandataire == true) {
                ...
                if (
                  ...
                  for (
                    let k = 0;
                    k <
                    contrat[i].foncier.proprietaire[j].proprietaire_list.length;
                    k++
                  ) {
                    montant_loyer_net =
                      +montant_loyer_net_mandataire +
                    ...
                    comptabilisationLoyerCrediter.push({
                      ...
                      date_gl: dateGenerationDeComptabilisation,
                      date_operation: dateGenerationDeComptabilisation,
                      cin: contrat[i].foncier.proprietaire[j].proprietaire_list[
                        k
                      ].cin,
                      passport:
                        contrat[i].foncier.proprietaire[j].proprietaire_list[k]
                ...
                ordreVirement.push({
                  ...
                  nom_agence_bancaire:
                    contrat[i].foncier.proprietaire[j].nom_agence_bancaire,
