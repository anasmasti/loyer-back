        ...
        if (contrat[i].etat_contrat.libelle == "Actif") {
            ...
            if (
              ...
              for (let g = 0; g < contrat[i].foncier.lieu.length; g++) {
                if (contrat[i].foncier.lieu[g].deleted == false) {
                  for (
                    let j = 0;
                    j < contrat[i].foncier.proprietaire.length;
                    j++
                  ) {
                    if (
                      ...
                      montant_tax_mandataire =
                        contrat[i].foncier.proprietaire[j]
                          .tax_avance_proprietaire +
                        contrat[i].foncier.proprietaire[j].tax_par_periodicite;
                      ...
                      comptabilisationLoyerCrediter.push({
                        ...
                        carte_sejour:
                          contrat[i].foncier.proprietaire[j].carte_sejour,
                        type: "LOY",
                        adresse_proprietaire:
                          contrat[i].foncier.proprietaire[j].adresse,
                        adresse_lieu: contrat[i].foncier.adresse,
                        origine: "PAISOFT",
                        devises: "MAD",
                        intitule_lieu:
                          contrat[i].foncier.lieu[g].lieu.intitule_lieu,
                        code_lieu: contrat[i].foncier.lieu[g].lieu.code_lieu,
                        etablissement: "01",
                        centre_de_cout: "NS",
                        direction_regional:
                          contrat[i].foncier.lieu[g].lieu.type_lieu ==
                          "Direction régionale"
                      ...
                      if (
                        contrat[i].foncier.proprietaire[j].proprietaire_list
                          .length != 0
                      ) {
                        for (
                          let k = 0;
                          ...
                          montant_loyer_net = +(
                            ...
                            (contrat[i].foncier.proprietaire[j]
                              ...
                              .montant_avance_proprietaire -
                              contrat[i].foncier.proprietaire[j]
                                .proprietaire_list[k].tax_avance_proprietaire) +
                            contrat[i].foncier.proprietaire[j]
                              .proprietaire_list[k].caution_par_proprietaire +
                            contrat[i].foncier.proprietaire[j]
                              .proprietaire_list[k].montant_apres_impot
                          );
                          ...
                          montant_loyer_brut =
                            ...
                            (contrat[i].foncier.proprietaire[j]
                              ...
                              contrat[i].foncier.proprietaire[j]
                                .proprietaire_list[k].caution_par_proprietaire +
                              contrat[i].foncier.proprietaire[j]
                                .proprietaire_list[k].montant_loyer);
                          ...
                          montant_tax =
                            ...
                            contrat[i].foncier.proprietaire[j]
                              .proprietaire_list[k].tax_avance_proprietaire +
                            contrat[i].foncier.proprietaire[j]
                              .proprietaire_list[k].tax_par_periodicite;
                          ...
                          comptabilisationLoyerCrediter.push({
                            ...
                            date_gl: dateGenerationDeComptabilisation,
                            date_operation: dateGenerationDeComptabilisation,
                            cin: contrat[i].foncier.proprietaire[j]
                              .proprietaire_list[k].cin,
                            passport:
                              contrat[i].foncier.proprietaire[j]
                                .proprietaire_list[k].passport,
                            carte_sejour:
                              contrat[i].foncier.proprietaire[j]
                                .proprietaire_list[k].carte_sejour,
                            type: "LOY",
                            adresse_proprietaire:
                              contrat[i].foncier.proprietaire[j]
                                .proprietaire_list[k].adresse,
                            adresse_lieu: contrat[i].foncier.adresse,
                            origine: "PAISOFT",
                            devises: "MAD",
                            intitule_lieu:
                      ...
                      montantDebiter =
                        contrat[i].montant_loyer +
                        contrat[i].montant_avance +
                        contrat[i].montant_caution;
                      ...
                      ordreVirement.push({
                        ...
                        carte_sejour:
                          contrat[i].foncier.proprietaire[j].carte_sejour,
                        nom_prenom:
                          contrat[i].foncier.proprietaire[j].nom_prenom,
                ...
                if (contrat[i].foncier.lieu[g].deleted == false) {
                  for (
                    ...
                    if (
                      ...
                      montantDebiter =
                        contrat[i].montant_loyer + contrat[i].montant_caution;
          ...
          if (contrat[i].periodicite_paiement == "annuelle") {
            ...
            if (
              ...
              let nextDateComptabilisation = dateDebutLoyer.setFullYear(
                    ...
                    for (
                      ...
                      if (
                        ...
                        comptabilisationLoyerCrediter.push({
                          ...
                          devises: "MAD",
                          intitule_lieu:
                            contrat[i].foncier.lieu[g].intitule_lieu,
                          code_lieu: contrat[i].foncier.lieu[g].code_lieu,
                          etablissement: "01",
                          centre_de_cout: "NS",
                          direction_regional:
                            contrat[i].foncier.lieu[g].type_lieu ==
                            "Direction régionale"
            ...
            if (contrat[i].periodicite_paiement == "annuelle") {
              if (
                ...
                let nextDateComptabilisation =
                  dateDeComptabilisation.setFullYear(
                    dateDeComptabilisation.getFullYear() + 1
                  );
                await Contrat.findByIdAndUpdate(
                  { _id: contrat[i]._id },
