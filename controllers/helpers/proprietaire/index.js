...
module.exports = {
  ...
  duplicateProprietaire: async (req, res, proprietaire, contrat, newContrat, montantLoyer) => {
    ...
    const affectationProprietaire = new AffectationProprietaire({
      ...
      montant_avance_proprietaire: calculeProprietaire.montant_avance_proprietaire,
